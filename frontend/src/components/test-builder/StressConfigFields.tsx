...
export function StressConfigFields({ form }: ConfigFieldsProps) {
  ...
  return (
    <>
      ...
      <Input label="Step Size (users per step)" type="number" helperText="Users added each step" error={errors.stepSize?.message} {...register('stepSize')} />
